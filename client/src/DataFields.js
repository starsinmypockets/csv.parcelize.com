    ...
    return (
      <div>
        <Row id="data-field-controls" style={{textAlign: ''}}>    
          <Col>
            <h5><button className="increment-bucket" onClick={this.props.incrementDataFields}>+</button> <button className="increment-buckets" onClick={this.props.decrementDataFields}>-</button></h5>
          </Col>
        </Row>
        <Row id="data-fields">
          {this.getDataFields()}
