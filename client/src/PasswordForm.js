    ...
    <form onSubmit={handleSubmit}>
      <div class="password-form-inputs" style={{minHeight: '60px'}}>
        ...
        <input
          ...
          onBlur={handleBlur}
          className={
            errors.confirmPmail && touched.confirmPassword
              ? 'text-input error'
              : 'text-input'
          }
        />
      ...
      <div class="topmatter">
        <p>
          Welcome to Parcelize. Please choose a strong password to get started!
        </p>
      </div>
    ...
    return (
      <div id="bucketize-home">
        <Row>
          ...
          <Col md={6} mdPush={3}>
            <EnhancedForm passwordAction={this.props.passwordAction} />
          </Col>
        </Row>
      </div>
    );
